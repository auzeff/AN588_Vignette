...
We can see that everything aligns pretty well! Our results align to our tree creation parameters.
...
In true practice, we also need to consider the concept of **Burn in*.*** `mcmc()` doesn't automatically do this nor does it have a parameter to do this, so we would need to do this manually and decide how much burn in we consider the model to have.
