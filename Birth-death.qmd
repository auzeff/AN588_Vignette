...
$$\
In addition to $t_i$, we see several new variables. $T$ represents the present time, $N$ is the total number of lineages in the phylogeny, and $(1-u_{x_i})$ is the probability of a single lineage after an amount of time $x_i$.
...
If we repeat this process many many times, essentially creating a "random walk" along the parameter space, we will eventually get the posterior distribution!
