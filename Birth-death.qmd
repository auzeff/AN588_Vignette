...
![](images/Screen%20Shot%202025-04-08%20at%201.18.42%20PM.png){fig-align="center" width="567"}
...
```{r}
current_lik <- current_lik + log(prior_fn_normal(current_par)) # Posterior = Prior x Likelihood but eveerything is in log
```
